package androidapps.brontomaps;
...
public class MainActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        mDialog.setMessage("Buscando libros...");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        //Log.d("BronToMaps", position + ": " + mNameList.get(position));
    ...
    public void displayWelcome() {
        ...
        if (name.length() > 0) {
            ...
            Toast.makeText(this, "Hola de nuevo, " + name + "!", Toast.LENGTH_LONG).show();
        } else {
            ...
            alert.setPositiveButton("Guardar", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int whichButton) {
                    ...
                    Toast.makeText(getApplicationContext(), "Hola, " + inputName + "!", Toast.LENGTH_LONG).show();
                }
            });
        ...
        client.get(QUERY_URL + urlString,
                new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(JSONObject jsonObject) {
                        ...
                        //Log.d("BronToMaps", jsonObject.toString());
                    ...
                    public void onFailure(int statusCode, Throwable throwable, JSONObject error) {
                        ...
                        Log.e("BronToMaps", statusCode + " " + throwable.getMessage());
                    }
                });
    }
}
